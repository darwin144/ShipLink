...
{
    [ApiController]
    [Route("API-Shiplink/[controller]")]
    public abstract class BaseController<TModel, TViewModel> : ControllerBase where TModel : class where TViewModel : class
    {
        private readonly IGenericRepository<TModel> _repository;
        private readonly IMapper<TModel, TViewModel> _mapper;

        protected BaseController(IGenericRepository<TModel> repository, IMapper<TModel, TViewModel> mapper)
        {
